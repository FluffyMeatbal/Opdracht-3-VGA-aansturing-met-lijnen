...
synth_design -top VGA_aansturing -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef VGA_aansturing.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file VGA_aansturing_utilization_synth.rpt -pb VGA_aansturing_utilization_synth.pb"  } 
